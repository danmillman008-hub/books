...
from .exam import register as register_exam
...
exam_app = typer.Typer(help="Exam packs, practice tests, adaptive diagnostic, study plan, score predictor.")
